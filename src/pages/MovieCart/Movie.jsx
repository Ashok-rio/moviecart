          ...
          <Container style={{ padding: '15px' }}>
               <Row>
                    <Col lg={5} md={6} sm={12} xs={12}>
                         <img src={`${IMAGE_URL}${movie.poster_path}`} style={{ width: '80%', height: '100%' }} alt={movie.original_title} />
                    </Col>
                    <Col lg={7} md={6} sm={12} xs={12}>
                         ...
                         <div
                              ...
                              <div
                                   ...
                                   <img src={IMDB} style={{ width: '30px', height: '20px' }} alt={'imdb'} />
                              ...
                              <div
                                   ...
                                   <img src={STAR} style={{ width: '20px', height: '20px' }} alt={'star'} />
                                   <p style={{ fontSize: '12px', fontWeight: 'bold', color: '#000', margin: '10px' }}>
                                        {movie.vote_count}
                                   </p>
                              </div>
